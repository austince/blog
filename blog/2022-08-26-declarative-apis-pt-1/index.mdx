...
import tweetScreenshotDark from './tweet-1532882337658044416-dark.png'
import tweetScreenshotLight from './tweet-1532882337658044416-light.png'
...
<div className="center">
    <a href="https://x.com/gwenshap/status/1532882337658044416">
        <ThemedImage
            light={tweetScreenshotLight}
            dark={tweetScreenshotDark}
            style={{maxWidth: "50%"}}
            alt="A screenshot of a tweet from @gwenshap that reads 'Most developers don't even think about what they use for IDs. But the SaaS Developer Community slack has a long thread debating alternative solutions - complete with references and horror stories.
...
api insert-into \
  --table=$(api get tables --name=Puppies | jq -r '.[0].id') \
